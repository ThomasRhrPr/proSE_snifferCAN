...
\begin{longtable}[l]{|m{0.3\linewidth}|m{0.6\linewidth}|} 
    ...
    \hline
        \centering [dossier\_de\_specifi-cation\_SPEC\_B1\_2024] \label{SPEC} & {\teamName}, Dossier de specification, version 1.4, 2023, \path{Git/doc/specification/livrables/}. \\
    \hline
\end{longtable}