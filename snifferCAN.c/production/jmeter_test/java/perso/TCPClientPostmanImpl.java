...
/**
 * Classe du client TCP à utiliser avec JMeter pour tester Postman.
 * 
 * <p>Peut être utilisé pour tester le serveur TCP du Postman dans le programme CANgateway. 
 * implémenté avec BufferedReader et BufferedWriter.</p>
 * 
 * @version 4.0
 * @author Matthias Brun, Camille Constant
 * 
 * modified by Thomas Rocher
 *
 * @see org.apache.jmeter.protocol.tcp.sampler.TCPClient
 * 
 */
public class TCPClientPostmanImpl implements TCPClient
{
	/** 
